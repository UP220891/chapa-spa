...
const RegisterForm = () => {
  ...
  return (
    <div className="register-container" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(90deg, #f7fafd 60%, #fff 40%)', position: 'relative' }}>
      {notification && (
        <div
          ...
          <form className="register-form" ref={formRef} onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.3rem' }}>
            <div style={{ display: 'flex', gap: '2rem' }}>
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '0.7rem' }}>
                ...
                <input type="text" id="name" placeholder="Ingresar Nombre" className="register-input" required style={{ fontSize: '1.08rem', fontWeight: 600, color: '#204d47', background: '#f7fafd', height: '52px', border: '1px solid #b5c7c6', borderRadius: '8px', width: '100%' }} />
              </div>
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '0.7rem' }}>
                <label htmlFor="email" className="register-label">Email</label>
                <input type="email" id="email" placeholder="Ingresar Email" className="register-input" required style={{ fontSize: '1.08rem', fontWeight: 600, color: '#204d47', background: '#f7fafd', height: '52px', border: '1px solid #b5c7c6', borderRadius: '8px', width: '100%' }} />
              </div>
            </div>
            <div style={{ display: 'flex', gap: '2rem' }}>
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '0.7rem' }}>
                ...
                <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
                  <input
                    ...
                    required
                    style={{ fontSize: '1.08rem', fontWeight: 600, color: '#204d47', background: '#f7fafd', paddingRight: '2.2rem', height: '52px', border: '1px solid #b5c7c6', borderRadius: '8px', width: '100%' }}
                  />
                  <button
                    type="button"
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '0.7rem' }}>
                ...
                <input type="tel" id="phone" placeholder="Ingresar Teléfono" className="register-input" required style={{ fontSize: '1.08rem', fontWeight: 600, color: '#204d47', background: '#f7fafd', height: '52px', border: '1px solid #b5c7c6', borderRadius: '8px', width: '100%' }} />
              </div>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.7rem', marginBottom: '1.2rem' }}>
              ...
              <input type="date" id="birthdate" className="register-input" required style={{ fontSize: '1.08rem', fontWeight: 600, color: '#204d47', background: '#f7fafd', height: '52px', border: '1px solid #b5c7c6', borderRadius: '8px', width: '100%' }} placeholder="Seleccionar Fecha de nacimiento" />
            </div>
